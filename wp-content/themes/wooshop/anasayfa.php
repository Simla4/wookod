...
<div class="swiper-wrapper" >
	...
	<?php if(have_rows('anasayfa_slider', 'option') ): ?>
	<?php while(have_rows('anasayfa_slider', 'option') ) : the_row(); ?>

	<?php $slide_gorseli = get_sub_field('slide_gorseli'); ?>
	<div class="swiper-slide">
		<a href="<?php the_sub_field('slide_linki'); ?>"><img src="<?php echo $slide_gorseli['url']; ?>"></a>
	</div>
	<?php endwhile; ?>
	<?php endif; ?>
</div>
  ...
  <div class="row">
  	...
  	<?php while (have_rows('slider_alti_kutulari', 'option') ) : the_row(); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-10 col-lg-10 col-10"><strong><?php the_sub_field('slider_alti_kutu_baslik'); ?></strong><br><?php the_sub_field('slider_alti_kutu_yazi'); ?>            </div>
        </div>
    </div>
...
<?php $kalan_sure = get_field('bugunun_indirimleri_sayac', 'option'); 
	...
	$tercumeler = ['Ocak' => 'Jan', 'Şubat' => 'Feb', 'Mart' => 'Mar', 'Nisan' => 'Apr', 'Mayıs' => 'May', 'Haziran' => 'Jun', 'Temmuz' => 'Jul', 'Ağustos' => 'aug', 'Eylül' => 'Sep', 'Ekim' => 'Oct', 'Kasım' => 'Nov', 'Aralık' => 'Dec'];
	$tarih = strtr($kalan_sure, $tercumeler);

	 ?>
    
<div class="col-md-6 anasayfa-sayac" >
<span class="sayac-baslik"><?php the_field('sayac_baslik', 'option'); ?></span>
<div class="sayac">
...
var saniye = Math.floor((t % (1000 * 60)) / 1000); 
    ...
    if (t < 0) { 
       ...
       document.getElementById("sayac-zaman").innerHTML = gun + " gün " + saat + " saat " + dakika + " dakika " + saniye + " saniye"; 
    }
...
<div class="row">
<div class="col-md-3">
<h2 class="anasayfa-bolum-baslik kalin-baslik"><?php the_field('anasayfa_blog_baslik', 'option'); ?></h2>    
</div>    
</div>
...
<div class="row">
	...
	<?php 
		...
		$anasayfa_son_bloglar = new WP_Query($anasayfa_son_postlar_array);
	 ?>

	 <?php while($anasayfa_son_bloglar->have_posts() ) : $anasayfa_son_bloglar->the_post();?>
