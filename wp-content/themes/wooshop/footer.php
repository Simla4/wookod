    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <?php $footer_logosu = get_field('footer_logosu', 'option'); ?>

                <a href="<?php echo bloginfo('url'); ?>"><img class="footer-logosu img-fluid" src="<?php echo $footer_logosu['url']; ?>" alt=""></a>
            ...
            <div class="col-md-4">
               ...
               <div class="col-md-6">
                <div id="footer-menu1" class="footer-menu">
                    ...
                    <?php wp_nav_menu(array('theme_location' => 'footermenu1', 'footer-menu1' => 'footer-menu', 'menu_id' => 'footer-menu1')); ?>
                ...
                <div id="footer-menu2" class="footer-menu">
                    ...
                    <?php wp_nav_menu(array('theme_location' => 'footermenu2', 'footer-menu2' => 'footer-menu', 'menu_id' => 'footer-menu2')); ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 footer-odeme-logolari">
                <?php $footer_odeme_logo = get_field('footer_odeme_logolari', 'option'); ?>
